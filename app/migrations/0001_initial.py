    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preco', models.DecimalField(decimal_places=2, default=30, max_digits=50)),
                ('paginas', models.IntegerField()),
                ('idioma', models.CharField(max_length=30)),
                ('resumo', models.TextField(default='')),
                ('genero', models.CharField(choices=[('tr', 'Terror'), ('rm', 'Romance'), ('aa', 'Autoajuda'), ('av', 'Aventura'), ('mg', 'Mangá'), ('hq', 'História em Quadrinhos'), ('bg', 'Biografia')], max_length=2)),
